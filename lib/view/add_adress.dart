        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: AppTextfield(lable: "Enter First Name",),
            ),
            // 
            SizedBox(height: 15,),
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 15),
              child: AppTextfield(lable: "Enter Last Name",),
            ),
            // 
            SizedBox(height: 15,),
            titles(label: "City"),
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 15),
              child: AppTextfield(lable: "Select City",),
            ),
            // 
            SizedBox(height: 15,),
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 15),
              child: AppTextfield(lable: "Select Province",),
            ),
            // 
            SizedBox(height: 15,),
            titles(label: "Area"),
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 15),
              child: AppTextfield(lable: "Select Area",),
            ),
            // 
            SizedBox(height: 15,),
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 15),
              child: AppTextfield(lable: "Enter Postal Code",),
            ),
            // 
            SizedBox(height: 15,),
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 15),
              child: AppTextfield(lable: "Enter Phone Number",),
            ),
            // 
            SizedBox(height: 15,),
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 15),
              child: AppTextfield(lable: "Address Line",),
            ),
            // 
            SizedBox(height: 15,),
            Container(
