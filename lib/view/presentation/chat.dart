      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            SizedBox(height: 10,),
            Chatinfo(img: "assets/chatimg2.png", name: "Store Name", msg: "Hi, are you Available Tomorrow?", time: "10:36 AM", count: 0),
            SizedBox(height: 10,),
            Chatinfo(img: "assets/chatimg3.png", name: "Store Name", msg: "Hi, are you Available Tomorrow?", time: "10:37 AM", count: 1),
            SizedBox(height: 10,),
            Chatinfo(img: "assets/chatimg4.png", name: "Store Name", msg: "Hi, are you Available Tomorrow?", time: "10:35 AM", count: 0),
            SizedBox(height: 10,),
